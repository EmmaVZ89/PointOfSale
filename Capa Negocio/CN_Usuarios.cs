...
namespace Capa_Negocio
{
    public class CN_Usuarios
    {
        ...
        {
            // Validacion 1: No auto-eliminarse (esto requiere pasar el usuario logueado desde la UI)
            // Validacion 2: Baja Logica en capa de datos
            this.objDatos.CD_Eliminar(usuario);
        }
        #endregion

        #region REACTIVAR
        public void Reactivar(CE_Usuarios usuario)
        {
            this.objDatos.CD_Reactivar(usuario);
        }
        #endregion
